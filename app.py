...
with gr.Blocks(css = ".output-image, .input-image, .image-preview {height: 400px !important} ") as demo:
    ...
    with gr.Row():
        reference_image1  = gr.Image(label="model", scale=1, value="/content/OutfitAnyone/examples/basemodel.png")
        reference_image2  = gr.Image(label="garment", scale=1, value="/content/OutfitAnyone/examples/garment1.jpg")
        reference_image3  = gr.Image(label="result", scale=1, value="/content/OutfitAnyone/examples/result1.png")
    gr.Examples(
        examples=[
            ["/content/OutfitAnyone/examples/basemodel.png", "/content/OutfitAnyone/examples/garment1.png", "/content/OutfitAnyone/examples/result1.png"],
            ["/content/OutfitAnyone/examples/basemodel.png", "/content/OutfitAnyone/examples/garment2.png", "/content/OutfitAnyone/examples/result2.png"],
            ["/content/OutfitAnyone/examples/basemodel.png", "/content/OutfitAnyone/examples/garment3.png", "/content/OutfitAnyone/examples/result3.png"],
        ],
